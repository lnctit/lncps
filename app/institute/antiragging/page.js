...
export default function CoursesOffered() {
  const courses = [
    {
      course: "Dr. Mumuksha Jain",
      duration: "HOD(commerece & Dept. of Management)",
      eligibilty: "mumukshaj@gmail.com "
    },
    {
    ...
    {
        course: "Prof. Chirag Sharma",
        duration: "Assistant Professor",
        eligibilty: "CS40169@gmail.com"
      },
      {
        course: "Prof. Sarvesh Kumar Mishra",
        duration: "Assistant Professor",
        eligibilty: "smisra68@gmail.com"
      },
    {
      course: "Prof. Prabhat Mishra",
      duration: "Assistant Professor",
      eligibilty: "-"
    },
    // {
  ...
  return (
    <div className='pb-10'>
        <div
            ...
            >
                <h1 className=" uppercase font-bold text-5xl">Anti-Ragging Committee</h1>
            </div>
