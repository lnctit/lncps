      ...
      <div className='flex flex-col w-full justify-center items-center bg-[url("/MessageSvg.svg")]'>
        ...
        >
          ...
          {isEditMode ? (
            ...
            <button
              onClick={handleSubmit}
              className="w-20 my-5 mx-auto p-2 border border-gray-300 rounded-lg mb-4 focus:outline-none focus:border-gray-600 bg-white hover:bg-blue-800 text-blue-800"
            >
              Submit
            </button>
          )}
