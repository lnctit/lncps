          ...
          <div className="w-[390px] h-full rounded-xl">
            <Slider {...settings} ref={(slider) => setSlider1(slider)}>
              {firstHalfEventData.map((item, index) => (
                ...
                >
                  <div className="relative h-56 mx-4 -mt-6 overflow-hidden text-white shadow-lg bg-clip-border rounded-xl text-orange-gray-500 shadow-blue-gray-500/40">
                    <img
                      src={item.imageUrl}
                      alt={item.title}
                  ...
                  <div className="p-6 h-[200px] ">
                    <h5 className="block mb-2 font-sans text-xl antialiased font-semibold leading-snug tracking-normal text-orange-gray-900">
                      {item.title}
                    </h5>
            ...
            <Slider {...settings} ref={(slider) => setSlider2(slider)}>
              {secondHalfEventData.map((item, index) => (
                <div
                  ...
                  className="relative flex flex-col mt-6 text-gray-700 bg-white shadow-md bg-clip-border rounded-xl w-96"
                >
                  <div className="relative h-56 mx-4 lg:-mt-6 overflow-hidden text-white shadow-lg bg-clip-border rounded-xl text-orange-gray-500 shadow-blue-gray-500/40">
                    <img
                      src={item.imageUrl}
                      alt={item.title}
                      className="w-full h-full object-cover"
