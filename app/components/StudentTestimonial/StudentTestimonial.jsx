...
export default function StudentTestimonial({img,title,content}) {
  return (
    <>
     <div className="relative bg-gradient-to-r from-blue-700 via-blue-800 to-blue-100 text-white overflow-hidden  -z-10">
          {/* SVG Waves */}
          <svg
      ...
      <div className=" flex justify-around m-10 p-10 w-11/12 mx-auto">
        <div className=" w-full ">
          <h1 className="  text-blue-800 text-4xl">About</h1>
