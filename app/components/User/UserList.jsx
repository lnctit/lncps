                  ...
                  <td class="px-4 py-3">
                    <div class="flex items-center text-sm">
                      <input
                        ...
                        type="checkbox"
                        value=""
                        class="w-4 h-4 text-blue-800 bg-gray-100 border-gray-300 rounded focus:ring-blue-800 dark:focus:ring-blue-600 dark:ring-offset-gray-800 focus:ring-2 dark:bg-gray-700 dark:border-gray-600"
                      />
